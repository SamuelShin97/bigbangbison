...
public class ScoreBison : MonoBehaviour
{
    ...
    void ScoreRed(string maturityLevel, Collider bison)
    {
        ...
        //{
            ...
            {
                if (!(IsPlaying(soundMidPlay) || IsPlaying(soundFullPlay)))
                {
                    soundMidPlay.start();
                }
    ...
    void GetRidOfBison(Collider bison)
    {
        ...
        bison.gameObject.transform.position = new Vector3(9999, -9999, 9999);
        ...
        bison.gameObject.GetComponent<HerdAgent>().scored = true;
    }
}
